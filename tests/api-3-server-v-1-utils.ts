...
export function createSetDapiNameEvent(
  ...
  setDapiNameEvent.parameters.push(
  ...
  setDapiNameEvent.parameters.push(
    new ethereum.EventParam("dapiName", ethereum.Value.fromFixedBytes(dapiName))
  )
  setDapiNameEvent.parameters.push(
...
export function createUpdatedBeaconSetWithBeaconsEvent(
  ...
  let updatedBeaconSetWithBeaconsEvent = changetype<
    UpdatedBeaconSetWithBeacons
  >(newMockEvent())
  ...
  updatedBeaconSetWithBeaconsEvent.parameters.push(
    new ethereum.EventParam(
      "beaconSetId",
      ethereum.Value.fromFixedBytes(beaconSetId)
    )
  )
  updatedBeaconSetWithBeaconsEvent.parameters.push(
...
export function createUpdatedBeaconWithSignedDataEvent(
  ...
  let updatedBeaconWithSignedDataEvent = changetype<
    UpdatedBeaconWithSignedData
  >(newMockEvent())
...
export function createUpdatedOevProxyBeaconSetWithSignedDataEvent(
  ...
  let updatedOevProxyBeaconSetWithSignedDataEvent = changetype<
    UpdatedOevProxyBeaconSetWithSignedData
  >(newMockEvent())
...
export function createUpdatedOevProxyBeaconWithSignedDataEvent(
  ...
  let updatedOevProxyBeaconWithSignedDataEvent = changetype<
    UpdatedOevProxyBeaconWithSignedData
  >(newMockEvent())
...
export function createWithdrewEvent(
  ...
  withdrewEvent.parameters.push(
    new ethereum.EventParam("oevProxy", ethereum.Value.fromAddress(oevProxy))
  )
  withdrewEvent.parameters.push(
    new ethereum.EventParam(
      "oevBeneficiary",
      ethereum.Value.fromAddress(oevBeneficiary)
    )
  )
  withdrewEvent.parameters.push(
