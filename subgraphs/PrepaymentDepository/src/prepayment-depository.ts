...
export function handleDecreasedUserWithdrawalLimit(event: DecreasedUserWithdrawalLimitEvent): void {
  let entity = new DecreasedUserWithdrawalLimit(event.transaction.hash.concatI32(event.logIndex.toI32()));
...
export function handleIncreasedUserWithdrawalLimit(event: IncreasedUserWithdrawalLimitEvent): void {
  let entity = new IncreasedUserWithdrawalLimit(event.transaction.hash.concatI32(event.logIndex.toI32()));
  entity.user = event.params.user;
  entity.amount = event.params.amount;
  entity.withdrawalLimit = event.params.withdrawalLimit;
  entity.sender = event.params.sender;
...
export function handleSetWithdrawalDestination(event: SetWithdrawalDestinationEvent): void {
  let entity = new SetWithdrawalDestination(event.transaction.hash.concatI32(event.logIndex.toI32()));
  entity.user = event.params.user;
