...
describe('Describe entity assertions', () => {
  beforeAll(() => {
    ...
    let newSetDapiNameEvent = createSetDapiNameEvent(dataFeedId, dapiName, sender);
  ...
  test('SetDapiName created and stored', () => {
    ...
    assert.fieldEquals('SetDapiName', '0xa16081f360e3847006db660bae1c6d1b2e17ec2a-1', 'dataFeedId', '1234567890');
    assert.fieldEquals('SetDapiName', '0xa16081f360e3847006db660bae1c6d1b2e17ec2a-1', 'dapiName', '1234567890');
    assert.fieldEquals(
      'SetDapiName',
