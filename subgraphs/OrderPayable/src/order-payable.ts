import { PaidForOrder as PaidForOrderEvent, Withdrew as WithdrewEvent } from '../generated/OrderPayable/OrderPayable';
import { PaidForOrder, Withdrew } from '../generated/schema';

export function handlePaidForOrder(event: PaidForOrderEvent): void {
  let entity = new PaidForOrder(event.transaction.hash.concatI32(event.logIndex.toI32()));
