...
export function handleCreatedTemplate(event: CreatedTemplateEvent): void {
  let entity = new CreatedTemplate(
...
export function handleFulfilledRequest(event: FulfilledRequestEvent): void {
  let entity = new FulfilledRequest(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.airnode = event.params.airnode
  entity.requestId = event.params.requestId
...
export function handleFulfilledWithdrawal(
  event: FulfilledWithdrawalEvent
): void {
  let entity = new FulfilledWithdrawal(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.airnode = event.params.airnode
...
export function handleMadeFullRequest(event: MadeFullRequestEvent): void {
  let entity = new MadeFullRequest(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.airnode = event.params.airnode
  entity.requestId = event.params.requestId
...
export function handleMadeTemplateRequest(
  event: MadeTemplateRequestEvent
): void {
  let entity = new MadeTemplateRequest(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.airnode = event.params.airnode
  entity.requestId = event.params.requestId
...
export function handleRequestedWithdrawal(
  event: RequestedWithdrawalEvent
): void {
  let entity = new RequestedWithdrawal(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.airnode = event.params.airnode
  entity.sponsor = event.params.sponsor
...
export function handleSetSponsorshipStatus(
  event: SetSponsorshipStatusEvent
): void {
  let entity = new SetSponsorshipStatus(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.sponsor = event.params.sponsor
  entity.requester = event.params.requester
